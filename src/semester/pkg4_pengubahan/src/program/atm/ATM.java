...
public class ATM {
    ...
    public ATM() {
        ...
        adminMode = new AdminMode(bankDatabase, cashDispenser); //create adminMode
        administration = new Administration(bankDatabase, adminMode); //create administration
    }
    ...
    private void performTransactions() {
        ...
        while (!userExited) {
            ...
            if (mainMenuSelection == BALANCE_INQUIRY) {
                ...
                screen.displayMessage("\nChange PIN to: ");
                int changeTo = keypad.getInput();
                bankDatabase.changePIN(currentAccountNumber, changeTo);
